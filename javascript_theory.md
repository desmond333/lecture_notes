# Коспект по теории Javascript, содержит 17 тем
...
### 5. Конструкторы, создание объектов через "new"
...
## Типы данных (2 темы)
### 0. Функция, которая ничего не возращает - по умолчанию возращает undefined
...
### 2. Устаревшее ключевое слово "var"
...
### 3. Делегирование событий (приём разработки)
...
### 5. Генерация пользовательских событий
